<aside class="left-sidebar" data-sidebarbg="skin6">
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <!-- User Profile-->
                {{-- https://fontawesome.com/v4/icons/ xem icon --}}
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                        href="{{ route('adminhtml.home') }}" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                            aria-hidden="true"></i><span class="hide-menu">Dashboard</span></a></li>

                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                    href="{{ route('admin_product_list') }}" aria-expanded="false"><i class="me-3 fa fa-columns"
                        aria-hidden="true"></i><span class="hide-menu">Product</span></a></li>

                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                    href="{{ route('admin_cate_list') }}" aria-expanded="false"><i class="fa fa-random"
                        aria-hidden="true"></i><span class="hide-menu">Category</span></a></li>
