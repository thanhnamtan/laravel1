                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('adminhtml/assets/images/logo-icon.png') }}" alt="homepage" class="dark-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{ asset('adminhtml/assets/images/logo-text.png') }}" alt="homepage" class="dark-logo" />
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ asset('adminhtml/assets/images/users/1.jpg') }}" alt="user" class="profile-pic me-2">Markarn Doe
                            </a>
